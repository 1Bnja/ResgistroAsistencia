// ==========================================
// SCRIPT DE PRUEBA DE CORREO CON .ENV
...
if (!process.env.SMTP_USER || !process.env.SMTP_PASS) {
  ...
  console.log('SMTP_USER=admnredmail98@gmail.com');
  console.log('SMTP_PASS=dcdordhfggwgtrzn\n');
  process.exit(1);
}
...
async function enviarCorreoPrueba() {
  try {
    ...
    console.log('📬 Para:', process.env.SMTP_TO || process.env.SMTP_USER);
    console.log('🌐 Servidor:', process.env.SMTP_HOST || 'smtp.gmail.com');
    console.log('');

    const destinatario = process.env.SMTP_TO || process.env.SMTP_USER;

    const info = await transporter.sendMail({
      from: `"Sistema de Asistencia UTalca" <${process.env.SMTP_USER}>`,
      to: destinatario,
            ...
            <div class="content">
              ...
              <div class="info">
                ...
                <ul>
                  ...
                  <li><strong>Servidor:</strong> ${process.env.SMTP_HOST || 'smtp.gmail.com'}:${process.env.SMTP_PORT || 587}</li>
                  <li><strong>Cuenta:</strong> ${process.env.SMTP_USER}</li>
    ...
    console.log('\n💡 Posibles soluciones:');
    console.log('1. Verifica que el archivo .env esté en la misma carpeta');
    console.log('2. Verifica que la contraseña de aplicación sea correcta');
    console.log('3. Verifica que la autenticación en 2 pasos esté activa');
